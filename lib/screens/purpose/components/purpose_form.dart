...
class _CompletePurposeFormState extends State<CompletePurposeFrom> {
  ...
  Future<void> _fetchPurposeChoice() async {
    try {
      ...
      final List<Choice>? purposes = await _choiceService.getPurposeChoice();
  ...
  Future<List<Map<String, dynamic>>> getPurposeChoicesFromSQLite() async {
    // Assuming you have a function to get purpose choices from SQLite
    return await DatabaseHelper.instance.getPurpose();
  }
